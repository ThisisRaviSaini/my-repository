...
public class CommonMethods extends BaseClass {
	...
	/**********************************************************************************************
     * Method: Login()
     * Description:This method will take the arguments from testNG.xml file and will perform login 
     * into spotfire application.
	...
	
	{
		...
		//obj_common_methods.waitForElement(driver, ObjectRepository.by_Landingpage, 30);
	...
	/**********************************************************************************************
     * Method: make_direcory()
     * Description:This method will create folder where all screenshot will be saved.
       Created on : 01/29/2018
	 * @throws IOException 
...
//String FilePath = "D:\\Vaibhav\\Selenium\\Station Profile\\Vaibhav\\TestDataSheet\\Station_Profile_US_UAT.xlsx";
	...
	String UserStoryname = UserStory.getUS_name();
	  ...
	  /**********************************************************************************************
	     ...
	     * Description:This method will wait until the passed argument is visible
	       Created on : 01/29/2018
		...
		/**********************************************************************************************
	     * Method: ALM_Pass()
	     * Description:This method will update ALM
	       Created on : 01/29/2018
